import { workExperience as iWorExperience } from "@/types/work-experiences";
import SectionTitle from "../../components/SectionTitle";
import ExperienceItem from "./ExperienceItem";

type workExperienceProps = {
  experiences: iWorExperience[];
};

export const WorkExperience = ({ experiences }: workExperienceProps) => {
  return (
    <section className="container mx-auto  py-16 flex gap-10 md:gap-4 lg:gap-16 flex-col md:flex-row ">
